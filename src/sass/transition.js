...
const getDefaultTimeline = (node, delay) => {
    ...
    timeline
        ...
        .staggerFrom(texts, 0.4, { autoAlpha: 0, x: -50, ease: Power1.easeOut }, 0.5); // 0.4-duration; 0.5-second  div delays for .5ms from the first
